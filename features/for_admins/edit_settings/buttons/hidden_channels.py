...
class HiddenChannelsMenuButtons(FirewallButton):
    ...
    def __init__(
        ...
        super().__init__(
            label=translator.t(
                guild_id=guild_id, section="EDIT_SETTINGS", key="hidden_ch_menu"
            ),
...
class AddHiddenChannelButton(FirewallButton):
    ...
    def __init__(
        ...
        super().__init__(
            label=translator.t(
                guild_id=guild_id, section="EDIT_SETTINGS", key="add_hidden_ch"
            ),
...
class DeleteHiddenChannelButton(FirewallButton):
    ...
    def __init__(
        ...
        super().__init__(
            label=translator.t(
                guild_id=guild_id, section="EDIT_SETTINGS", key="delete_hidden_ch"
            ),
