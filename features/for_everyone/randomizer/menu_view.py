...
class RandomModeView(discord.ui.View):
    def __init__(
        ...
        self.add_item(
            RandomNumButton(flow=flow, translator=translator, guild_id=guild_id)
        )
        self.add_item(
            RandomWordButton(flow=flow, translator=translator, guild_id=guild_id)
        )
        self.add_item(
            RandomTeamByText(flow=flow, translator=translator, guild_id=guild_id)
        )
        self.add_item(
            RandomTeamByChannel(
